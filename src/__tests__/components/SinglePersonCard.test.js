...
describe("SinglePersonCard Component", () => {
    ...
    it("renders correctly with the given person data", () => {
        render(_jsx(SinglePersonCard, { person: mockPerson, editPersonDetails: mockEditPersonDetails, removeWantedPerson: mockRemoveWantedPerson }));
    ...
    it("renders close button when showCloseModal is true", () => {
        render(_jsx(SinglePersonCard, { person: mockPerson, editPersonDetails: mockEditPersonDetails, removeWantedPerson: mockRemoveWantedPerson, closeModal: mockCloseModal, showCloseModal: true }));
        const closeButton = screen.getByText("×");
        expect(closeButton).toBeInTheDocument();
    });
    it("does not render close button when showCloseModal is false", () => {
        render(_jsx(SinglePersonCard, { person: mockPerson, editPersonDetails: mockEditPersonDetails, removeWantedPerson: mockRemoveWantedPerson, closeModal: mockCloseModal, showCloseModal: false }));
