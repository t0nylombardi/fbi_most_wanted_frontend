...
//       : ".env.development",
// });
export const BASE_URL = process.env.API_URL || "https://fbi-most-wanted-backend.onrender.com/api/v1";
...
export const loadingMessages = [
    ...
    "What if the world ends while we wait? ",
    "You should totally tweet this while you wait, but no pressure. ",
    "How about donating to the host? ",
    "The cake is a lie. ",
